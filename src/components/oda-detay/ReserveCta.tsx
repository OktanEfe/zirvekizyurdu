...
export default function CtaBanner({ title, whatsappMessage }: ReserveCtaProps) {
  const whatsappHref = `https://wa.me/905382123011?text=${encodeURIComponent(whatsappMessage)}`;
            ...
            <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="max-w-2xl space-y-4">
                ...
                <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl leading-tight">
                  {title} için yerinde keşfetmeye hazır mısınız?
                </h2>

                <p className="text-sm text-slate-300 sm:text-base font-light leading-relaxed">
                  Erken kayıt avantajları ve {title.toLocaleLowerCase("tr-TR")} hakkında detaylı bilgi almak ya da yurdumuzu ziyaret etmek için bizimle iletişime geçin.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3.5 sm:flex-row sm:items-center shrink-0">
                ...
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-2.5 rounded-full bg-white px-5 py-3 sm:px-6 sm:py-3.5 lg:px-7 lg:py-4 text-sm font-bold text-slate-950 shadow-lg transition-all duration-300 hover:bg-slate-100 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center justify-center gap-2.5 rounded-full border border-white/20 bg-white/10 px-5 py-3 sm:px-6 sm:py-3.5 lg:px-7 lg:py-4 text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:border-white/40 hover:bg-white/20 hover:scale-[1.02] active:scale-[0.98]"
                >
